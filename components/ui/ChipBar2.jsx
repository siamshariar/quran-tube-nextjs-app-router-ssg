...
const ChipBar2 = ({ locales, activeId, subCatClickHandler }) => {
  ...
  const handleItemClick = (id, code) => {
    ...
    router.push(`/learn-quran/${encodeURIComponent(code)}`, undefined, { shallow: true }); // Update URL without page reload
  };
